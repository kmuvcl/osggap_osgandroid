...
public class Matrix implements Native {
	...
	private static native float nativeGetElement(long cptr, int row, int col);
	
	private static native void nativeInverse(long cptr, long matrix);
	...
	public float getElement(int row, int col) {
		return nativeGetElement(_cptr, row, col);
	}
