...
public class Group extends Node {
	...
	private static native void nativeTurnOffLight(long cptr);
	private static native void nativeAddLight(long cptr, float x, float y, float z);
	...
	public void turnOffLight() {
		nativeTurnOffLight(_cptr);
	}

	public void addLight(float x, float y, float z) {
		nativeAddLight(_cptr, x, y, z);
	}
}
