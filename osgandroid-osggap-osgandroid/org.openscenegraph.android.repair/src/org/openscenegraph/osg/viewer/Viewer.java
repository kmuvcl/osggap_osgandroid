...
import org.openscenegraph.osg.util.GUIEventHandler;
import org.openscenegraph.osg.util.PickHandler;
import org.openscenegraph.osg.util.TrackballManipulator;
...
public class Viewer extends GLSurfaceView implements Native,
    ...
    //add
    protected native void nativeAddEventHandler(long cptr, long cptrpicker);
    
    //add
    protected native double nativeGetFPS(long cptr);
	...
	//add
	public void addEventHandler(GUIEventHandler handle) {
			nativeAddEventHandler(getNativePtr(), handle.getNativePtr());
	}
...
//				EGL10.EGL_RENDERABLE_TYPE, EGL_OPENGL_ES_BIT, EGL10.EGL_NONE };
	...
	public boolean onTouch(View arg0, MotionEvent event) {
		...
		//kookmin : TouchEventListener에서 처리
